  ...
  return (
    <div className="mx-auto py-6 flex flex-col justify-center items-center align-middle my-auto">
      <div className="relative lg:w-[70%] align-middle items-center">
        ...
        />
        <div className="absolute top-0 ml-4 lg:left-16 flex justify-between md:w-[700px]">
          <div className="mt-2 md:mt-10 mx-2 md:mx-10">
            <h1 className="text-white text-sm md:text-lg rounded-lg bg-black p-1 md:p-2 bg-opacity-30 font-bold">
              Add Queries and get Recommendations.. 
            </h1>
            <Link to='/addQueries'>
          ...
          <div>
            <img
              ...
              alt=""
              className="max-h-[80px] md:max-h-[170px] lg:max-h-[180px] mt-1 lg:mt-2 h-full mx-4"
            />
          </div>
        </div>
      </div>
