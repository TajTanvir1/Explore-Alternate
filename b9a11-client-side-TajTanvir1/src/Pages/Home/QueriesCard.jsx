...
const QueriesCard = ({ query }) => {
  ...
  return (
    <div data-aos="flip-left" data-aos-duration="2000" className="gap-4 space-y-4 my-4 mx-auto">
      {/* <h1>Queries: {productName}</h1> */}

      <div className="w-[350px] min-h-[500px] border-2 border-orange-200 p-2 rounded-lg lit-bg">
        {/* Card Top */}
        <div className="">
